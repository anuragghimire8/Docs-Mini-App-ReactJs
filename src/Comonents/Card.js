...
const Card = ({data,refrence}) => {
  ...
  return (
    <motion.div drag dragConstraints={refrence} whileDrag={{scale :1.2}} dragElastic={{scale:0.2}} className='relative flex-shrink-0  w-60 h-72 rounded-[50px] text-white bg-black p-10 overflow-hidden'>
      <FaRegFileAlt />
